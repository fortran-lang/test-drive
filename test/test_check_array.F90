...
contains
  ...
  subroutine collect_check_array(testsuite)
  ...
  subroutine test_failure_message(error)
    ...
    call check(error, [7, 7], "Custom message describing the error")
  ...
  subroutine test_failure_with_more(error)
    ...
    call check(error, [7, 7], more="with an additional descriptive message here")
  ...
  subroutine test_expression(error)
    ...
    call check(error, [.true., .true.], "Expression failed")
  ...
  subroutine test_expression_fail(error)
    ...
    call check(error, [.false., .false.], "Expression failed")
  ...
  subroutine test_expression_message(error)
    ...
    call check(error, [.false., .true.], 'Expression with message failed')
  ...
  subroutine test_expression_with_more(error)
    ...
    call check(error, [.false., .true.], more='Expression with more failed')
  ...
  subroutine test_rsp_abs(error)
    ...
    call check(error, val, [3.3_sp, 3.3_sp], thr=sqrt(epsilon(val)))
  ...
  subroutine test_rsp_nan(error)
    ...
    call check(error, val, [3.3_sp, 3.3_sp], rel=.true.)
  ...
  subroutine test_rsp_abs_fail(error)
    ...
    call check(error, val, [2.0_sp, 2.0_sp])
  ...
  subroutine test_rsp_rel_fail(error)
    ...
    call check(error, val, [1.5_sp, 1.5_sp], rel=.true.)
  ...
  subroutine test_rsp_abs_message(error)
    ...
    call check(error, val, [1.5_sp, 1.5_sp], message="Actual value is not 1.5")
  ...
  subroutine test_rdp_abs(error)
    ...
    call check(error, val, [3.3_dp, 3.3_dp], thr=sqrt(epsilon(val)))
  ...
  subroutine test_rdp_rel(error)
    ...
    call check(error, val, [3.3_dp, 3.3_dp], rel=.true.)
  ...
  subroutine test_rdp_abs_fail(error)
    ...
    call check(error, val, [2.0_dp, 2.0_dp])
  ...
  subroutine test_rdp_rel_fail(error)
    ...
    call check(error, val, [1.5_dp, 1.5_dp], rel=.true.)
  ...
  subroutine test_rdp_abs_message(error)
    ...
    call check(error, val, [1.5_dp, 1.0_dp], message="Actual value is not 1.5")
  ...
  subroutine test_rxdp_abs(error)
    ...
    call check(error, val, [3.3_xdp, 3.3_xdp], thr=sqrt(epsilon(val)))
#else
  ...
  subroutine test_rxdp_rel(error)
    ...
    call check(error, val, [3.3_xdp, 3.3_xdp], rel=.true.)
#else
    call skip_test(error, "Extended double precision is not enabled")
#endif
  ...
  subroutine test_rxdp_abs_fail(error)
    ...
    call check(error, val, [2.0_xdp, 2.0_xdp])
#else
    call skip_test(error, "Extended double precision is not enabled")
#endif
  ...
  subroutine test_rxdp_rel_fail(error)
    ...
    call check(error, val, [1.5_xdp, 1.5_xdp], rel=.true.)
#else
    call skip_test(error, "Extended double precision is not enabled")
#endif
  ...
  subroutine test_rxdp_abs_message(error)
    ...
    call check(error, val, [1.5_xdp, 1.5_xdp], message="Actual value is not 1.5")
#else
    call skip_test(error, "Extended double precision is not enabled")
#endif
  ...
  subroutine test_rqp_abs(error)
    ...
    call check(error, val, [3.3_qp, 3.3_qp], thr=sqrt(epsilon(val)))
#else
  ...
  subroutine test_rqp_rel(error)
    ...
    call check(error, val, [3.3_qp, 3.3_qp], rel=.true.)
#else
    call skip_test(error, "Quadruple precision is not enabled")
#endif
  ...
  subroutine test_rqp_abs_fail(error)
    ...
    call check(error, val, [2.0_qp, 2.0_qp])
#else
    call skip_test(error, "Quadruple precision is not enabled")
#endif
  ...
  subroutine test_rqp_rel_fail(error)
    ...
    call check(error, val, [1.5_qp, 1.5_qp], rel=.true.)
#else
    call skip_test(error, "Quadruple precision is not enabled")
#endif
  ...
  subroutine test_rqp_abs_message(error)
    ...
    call check(error, val, [1.5_qp, 1.5_qp], message="Actual value is not 1.5")
#else
    call skip_test(error, "Quadruple precision is not enabled")
#endif
  ...
  subroutine test_csp_abs(error)
    ...
    call check(error, val, [cmplx(3.3_sp, 1.0_sp, sp), cmplx(3.3_sp, 1.0_sp, sp)], thr=sqrt(epsilon(abs(val))))
  ...
  subroutine test_csp_nan(error)
    ...
    call check(error, val, [cmplx(3.3_sp, 1.0_sp, sp), cmplx(3.3_sp, 1.0_sp, sp)], rel=.true.)
  ...
  subroutine test_csp_abs_fail(error)
    ...
    call check(error, val, [cmplx(2.0_sp, 1.0_sp, sp), cmplx(3.3_sp, 1.0_sp, sp)])
  ...
  subroutine test_csp_rel_fail(error)
    ...
    call check(error, val, [cmplx(1.5_sp, 1.0_sp, sp), cmplx(3.3_sp, 1.0_sp, sp)], rel=.true.)
  ...
  subroutine test_csp_abs_message(error)
    ...
    call check(error, val, [cmplx(1.5_sp, 1.0_sp, sp), cmplx(3.3_sp, 1.0_sp, sp)], &
               message="Actual value is not 1.5+1.0i")
  ...
  subroutine test_cdp_abs(error)
    ...
    call check(error, val, [cmplx(3.3_dp, 1.0_dp, dp), cmplx(3.3_dp, 1.0_dp, dp)], &
               thr=sqrt(epsilon(real(val))))
  ...
  subroutine test_cdp_rel(error)
    ...
    call check(error, val, [cmplx(3.3_dp, 1.0_dp, dp), cmplx(3.3_dp, 1.0_dp, dp)], rel=.true.)
  ...
  subroutine test_cdp_abs_fail(error)
    ...
    call check(error, val, [cmplx(2.0_dp, 1.0_dp, dp), cmplx(3.3_dp, 1.0_dp, dp)])
  ...
  subroutine test_cdp_rel_fail(error)
    ...
    call check(error, val, [cmplx(1.5_dp, 1.0_dp, dp), cmplx(3.3_dp, 1.0_dp, dp)], rel=.true.)
  ...
  subroutine test_cdp_abs_message(error)
    ...
    call check(error, val, [cmplx(1.5_dp, 1.0_dp, dp), cmplx(3.3_dp, 1.0_dp, dp)], &
               message="Actual value is not 1.5+1.0i")
  ...
  subroutine test_cxdp_abs(error)
    ...
    call check(error, val, [cmplx(3.3_xdp, 1.0_xdp, xdp), cmplx(3.3_xdp, 1.0_xdp, xdp)], &
               thr=sqrt(epsilon(real(val))))
#else
    call skip_test(error, "Extended double precision is not enabled")
#endif
  ...
  subroutine test_cxdp_rel(error)
    ...
    call check(error, val, [cmplx(3.3_xdp, 1.0_xdp, xdp), cmplx(3.3_xdp, 1.0_xdp, xdp)], rel=.true.)
#else
    call skip_test(error, "Extended double precision is not enabled")
#endif
  ...
  subroutine test_cxdp_abs_fail(error)
    ...
    call check(error, val, [cmplx(2.0_xdp, 1.0_xdp, xdp), cmplx(3.3_xdp, 1.0_xdp, xdp)])
#else
    call skip_test(error, "Extended double precision is not enabled")
#endif
  ...
  subroutine test_cxdp_rel_fail(error)
    ...
    call check(error, val, [cmplx(1.5_xdp, 1.0_xdp, xdp), cmplx(3.3_xdp, 1.0_xdp, xdp)], rel=.true.)
#else
    call skip_test(error, "Extended double precision is not enabled")
#endif
  ...
  subroutine test_cxdp_abs_message(error)
    ...
    call check(error, val, [cmplx(1.5_xdp, 1.0_xdp, xdp), cmplx(3.3_xdp, 1.0_xdp, xdp)], &
               message="Actual value is not 1.5+1.0i")
#else
    call skip_test(error, "Extended double precision is not enabled")
#endif
  ...
  subroutine test_cqp_abs(error)
    ...
    call check(error, val, [cmplx(3.3_qp, 1.0_qp, qp), cmplx(3.3_qp, 1.0_qp, qp)], &
               thr=sqrt(epsilon(real(val))))
#else
    call skip_test(error, "Quadruple precision is not enabled")
#endif
  ...
  subroutine test_cqp_rel(error)
    ...
    call check(error, val, [cmplx(3.3_qp, 1.0_qp, qp), cmplx(3.3_qp, 1.0_qp, qp)], rel=.true.)
#else
    call skip_test(error, "Quadruple precision is not enabled")
#endif
  ...
  subroutine test_cqp_abs_fail(error)
    ...
    call check(error, val, [cmplx(2.0_qp, 1.0_qp, qp), cmplx(3.3_qp, 1.0_qp, qp)])
#else
    call skip_test(error, "Quadruple precision is not enabled")
#endif
  ...
  subroutine test_cqp_rel_fail(error)
    ...
    call check(error, val, [cmplx(1.5_qp, 1.0_qp, qp), cmplx(1.5_qp, 1.0_qp, qp)], rel=.true.)
#else
    call skip_test(error, "Quadruple precision is not enabled")
#endif
  ...
  subroutine test_cqp_abs_message(error)
    ...
    call check(error, val, [cmplx(1.5_qp, 1.0_qp, qp), cmplx(1.5_qp, 1.0_qp, qp)], &
               message="Actual value is not 1.5+1.0i")
#else
    call skip_test(error, "Quadruple precision is not enabled")
#endif
  ...
  subroutine test_i1(error)
    ...
    call check(error, val, [3_i1, 3_i1])
  ...
  subroutine test_i1_fail(error)
    ...
    call check(error, val, [-4_i1, -4_i1])
  ...
  subroutine test_i1_message(error)
    ...
    call check(error, val, [7_i1, 7_i1], "Actual value is not seven")
  ...
  subroutine test_i2(error)
    ...
    call check(error, val, [3_i2, 3_i2])
  ...
  subroutine test_i2_fail(error)
    ...
    call check(error, val, [-4_i2, -4_i2])
  ...
  subroutine test_i2_message(error)
    ...
    call check(error, val, [7_i2, 7_i2], "Actual value is not seven")
  ...
  subroutine test_i2_with_more(error)
    ...
    call check(error, val, [3_i2, 3_i2], more="with an additional descriptive message here")
  ...
  subroutine test_i4(error)
    ...
    call check(error, val, [3_i4, 3_i4])
  ...
  subroutine test_i4_fail(error)
    ...
    call check(error, val, [-4_i4, -4_i4])
  ...
  subroutine test_i4_message(error)
    ...
    call check(error, val, [7_i4, 7_i4], "Actual value is not seven")
  ...
  subroutine test_i8(error)
    ...
    call check(error, val, [3_i8, 3_i8])
  ...
  subroutine test_i8_fail(error)
    ...
    call check(error, val, [-4_i8, -4_i8])
  ...
  subroutine test_i8_message(error)
    ...
    call check(error, val, [7_i8, 7_i8], "Actual value is not seven")
  ...
  subroutine test_i8_with_more(error)
    ...
    call check(error, val, [3_i8, 3_i8], more="with an additional descriptive message here")
  ...
  subroutine test_l4_true(error)
    ...
    call check(error, [.true., .true.], [.true., .true.])
  ...
  subroutine test_l4_false(error)
    ...
    call check(error, [.false., .false.], [.false., .false.])
